          ...
          <Col xs={12} md={6} xl={7} className="banner-col-1">
            ...
            <div className="content-container">
              ...
              <Row xl={3} p={2} className="button-group">
                ...
                <Button className=" mx-3 registerUnstop" onClick={() => window.open("https://unstop.com/p/syrus-hackathon-2025-codecell-tinkerers-of-computer-eng-dept-at-vesit-1420661", "_blank")}>Register On Unstop</Button>
              </Row>
            </div>
          </Col>
